(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["addComment"], {
    "2cab": function (t, e, n) {
        ...
        }, o = [], c = (n("a4d3"), n("4de4"), n("e439"), n("dbb4"), n("b64b"), n("d3b7"), n("159b"), n("96cf"), n("ade3")), i = n("2f62");
                ...
                makeComment: function () {
                    ...
                    return regeneratorRuntime.async((function (e) {
                        while (1) switch (e.prev = e.next) {
                            ...
                            case 2:
                                t = {parent_id: this.commentParent, post_id: this.article.id, text: this.editorContent}, this.sendComment(t);
                            case 4:
                            case"end":
                                return e.stop()
                        }

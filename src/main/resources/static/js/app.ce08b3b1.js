(function (e) {
    ...
    i.e = function (e) {
        ...
        a[e] ? t.push(a[e]) : 0 !== a[e] && r[e] && t.push(a[e] = new Promise((function (t, r) {
            ...
            p.rel = "stylesheet", p.type = "text/css", p.onload = t, p.onerror = function (t) {
                var n = t && t.target && t.target.src || o, c = new Error("Loading CSS chunk " + e + " failed.\n(" + n + ")");
    ...
    0: function (e, t, r) {
        ...
        t["a"] = new o["default"].Store({
            state: {blogInfo: {}, years: [], settings: {}, errors: [], viewedErrors: {}}, getters: {
                blogInfo: function (e) {
                    return e.blogInfo
                }, years: function (e) {
                    return e.years
                ...
                getBlogInfo: function (e) {
                    ...
                    return regeneratorRuntime.async((function (n) {
                        while (1) switch (n.prev = n.next) {
                            case 0:
                                return t = e.commit, n.prev = 1, n.next = 4, regeneratorRuntime.awrap(s.a.get("".concat(i["a"], "/api/component")));
                            case 4:
        ...
        var n = r("2b0e"), a = r("2f62"), o = r("1573"), c = r.n(o), s = r("1dce"), i = r.n(s), u = r("58ca"), l = function () {
            var e = this, t = e.$createElement, r = e._self._c || t;
            return r("div", {attrs: {id: "app"}}, [r("ErrorModal"), r("Header"), r("router-view"), r("Footer")], 1)
        }, d = [], p = (r("a4d3"), r("4de4"), r("e439"), r("dbb4"), r("b64b"), r("d3b7"), r("159b"), r("ade3")), f = function () {
        ...
        }, y = v, w = (r("0b0a"), r("2877")), O = Object(w["a"])(y, f, h, !1, null, null, null), j = O.exports, E = function () {
            var e = this, t = e.$createElement, r = e._self._c || t;
        ...
        var L = function () {
            ...
            name: "app", components: {Header: j, Footer: I, ErrorModal: L}, computed: {
                errors: function () {
            ...
            }, methods: T({}, Object(a["mapActions"])(["getSettings", "getUser", "getYears", "getBlogInfo"])), mounted: function () {
                this.getBlogInfo(), this.getSettings(), this.getUser()
            }
        }, D = _, B = (r("5c0b"), Object(w["a"])(D, l, d, !1, null, null, null)), H = B.exports, M = r("a18c"), F = r("4360"), N = r("8c89"), U = {
        ...
        n["default"].use(a["a"]);
        var w = [{path: "/", redirect: "/posts/recent"}, {path: "/posts/*", name: "posts", component: s}, {
            path: "/moderation",
            ...
            component: g,
            props: {
                navItems: [{name: "Новые", value: "new"}, {name: "Отклоненные", value: "declined"}, {name: "Утвержденные", value: "accepted"}],
                forModeration: !0,
            ...
            component: g,
            props: {
                navItems: [{name: "Скрытые", value: "inactive"}, {name: "Активные", value: "pending"}, {
                    name: "Отклонённые",
                    value: "declined"
        ...
        }, {path: "/stat", name: "stat", component: u, className: "ArticlesContent Articles--noborder"}, {
            path: "/post/:id",
            name: "article",
            component: l
        }, {path: "/add", name: "add", component: p, props: {isEditPost: !1}, meta: {requiresAuth: !0}}, {
            path: "/edit/:id",
            name: "edit",
            component: p,
            meta: {requiresAuth: !0}
        }, {path: "/calendar", redirect: "/calendar/".concat((new Date).getFullYear())}, {
            path: "/calendar/:year",
            name: "calendar",
            component: d
        }, {path: "/calendar/:year/:date", name: "postsByDate", component: s}, {
            path: "/login",
            component: i,
